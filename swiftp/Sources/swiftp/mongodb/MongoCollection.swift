...
public class MongoIndexOptions {
    ...
    public init(name:String? = nil,background:Bool? = nil,unique:Bool? = nil, dropDups:Bool? = nil,sparse:Bool? = nil,expireAfterSeconds:Int32? = nil,v:Int32? = nil,defaultLanguage:String? = nil,languageOverride:String? = nil,weights:BSON? = nil,geoOptions:MongoIndexOptionsGeo? = nil ,storageOptions:MongoIndexStorageOptionType? = nil) {
...
public class MongoCollection {
    ...
    /*
     大部分涉及到指针的 API 里的 COpaquePointer 都被正确地归类到了合适的 Unsafe 指针中，因此现在在开发中可能很少能再看到 COpaquePointer 了。最多的使用场景可能就是 COpaquePointer 和某个特定的 Unsafe 之间的转换了
     */
    
    //MARK:COpaquePointer 不透明指针类型
